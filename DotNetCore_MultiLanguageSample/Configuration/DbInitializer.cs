...
namespace DotNetCore_MultiLanguageSample.Configuration
{
    public static class DbInitializer
    {
        ...
        public static void InitializeDb(this WebApplication app)
        {
            ...
            if (!context.Database.EnsureCreated()) throw new NullReferenceException(nameof(context));

            var title = new TranslationModel() { LanguagesContent = new List<TranslationLanguageModel>() { new("IPhone 13 pro") } };
            ...
            context.Translations.Add(title);
            context.Add(shortDescription);
            context.Add(longDescription);
